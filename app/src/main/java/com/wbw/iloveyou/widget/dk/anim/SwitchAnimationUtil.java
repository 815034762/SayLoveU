package com.wbw.iloveyou.widget.dk.anim;
...
public class SwitchAnimationUtil {
	...
	public SwitchAnimationUtil(int mDelay,int mDuration){
		this.mDelay = mDelay;
	...
	private void bindAnimation(View view, int depth, AnimationType type) {
		...
		if (view instanceof ViewGroup) {
			...
			if (type == AnimationType.HORIZON_CROSS) {
				...
				if(group.getId() == R.id.ll_ll_firstview_config ||
						group.getId() == R.id.ll_ll_secondview_config||
						group.getId() == R.id.ll_ll_thridview_config
						){
			...
			if(view.getId() == R.id.ll_ll_firstview_config ||
					view.getId() == R.id.ll_ll_secondview_config||
							view.getId() == R.id.ll_ll_thridview_config
					){
